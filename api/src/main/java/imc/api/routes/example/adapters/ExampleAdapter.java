package imc.api.routes.example.adapters;
...
public abstract class ExampleAdapter {
  ...
  protected Binds createAdapting(ExampleModel example) {
    StringBuilder sql = new StringBuilder("INSERT INTO TB_IMC_EXAMPLES (");
  ...
  protected Binds updateAdapting(ExampleModel example, long id) {
    StringBuilder sql = new StringBuilder("UPDATE TB_IMC_EXAMPLES SET ");
    List<Object> params = new ArrayList<>();
